<template>
  <div class="record-page">
    <div style="margin-bottom: 15px;">
      <button @click="startRecording" :disabled="videoStart" >start recording</button>
      <button @click="stopRecording" :disabled="!videoStart" id="btn-stop-recording">stop recording
      </button>
    </div>
